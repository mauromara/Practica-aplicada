...
<body>
	<div id = "contenedor">
		...
		<main class="mainRegistro">
			...
			<form action= "../php/guarda_agenda.php" method="POST" class="nuevaagenda">
				
                  <table>
                    <tr>
                      <td style="color:black; font-size: 20px;">Sede:</td><br>
                    ...
                    <tr>
                      <td style="color:black; font-size: 20px;">fecha agenda :</td>
                      <td><input type="date" name="fecha_agen" id="fecha" style="color:black; font-size: 20px;"></td>
                      </tr>
                      <tr>
                        <td style="color:black; font-size: 20px;">Hora agenda ;</td>
                        <td><input type="time" name="hora_agen" id="hora" style="color:black; font-size: 20px;"></td>
                      </tr>
                      <tr>
                          
                          <td><input type="text" disable  name="usuario" value="<?php echo$_SESSION['id_usuario']?>"></td>
                          </tr>
                      <tr>
